...
object BookWorkDtoSerializer : KSerializer<BookWorkDto> {
    ...
    override fun deserialize(decoder: Decoder): BookWorkDto = decoder
        .decodeStructure(descriptor) {
            ...
            while (true) {
                // index = order of the fields
                // description is the first element (index 0)
                // if we add another element, so there's another index
